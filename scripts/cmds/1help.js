...
const doNotDelete = "[ 🐥 | TOREKI V2 ]"; // changing this wont change the goatbot V2 of list cmd it is just a decoyy
  ...
  onStart: async function ({ message, args, event, threadsData, role }) {
    ...
    if (args.length === 0) {
      ...
      const helpListImages = [
        "https://i.ibb.co/sCcJp8m/image.jpg", // add image link here
                "https://i.ibb.co/b2Qpm3w/image.jpg",
        "https://i.ibb.co/kxmJgg2/image.jpg",
